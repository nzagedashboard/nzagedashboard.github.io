...
The below charts track **complete** graduate, intern and employer surveys, as well as how many bespoke reports have been earned. The survey closes on September 10. 
...
historical_data <- tibble::tribble(
  ~Year,           ~Employers, ~Grads, ~Interns, ~`Grad bespoke reports`,
  "2018",             38L,            591L,           NA, 27,
